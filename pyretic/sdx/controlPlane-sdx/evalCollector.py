...
#############################################
"""
Generic script to collect results from various experiments
"""
...
def send_email(option):
    ...
    TEXT = "Completed " + \
        str(option).upper() + " Benchmarking at: " + str(current_time)
...
def main(option):
        ...
        for ntot in nparts:
            ...
            for npfx in npfxes:
                ...
                for dp in range(dataPoints):
                    ...
                    q = Queue()
                    p = Process(
                        target=UPDATEDcompilationTimeExperiment,
                        args=(
                            ntot,
                            npfx,
                            nfields,
                    ...
                    with open(dname, 'w') as outfile:
                        json.dump(
                            ...
                            encoding="ascii")
                    print data
                    msg = 'MATTAPAN: Completed Init Compile for ' + str(ntot) + ' participants ' + str(npfx) + ' prefix sets iteration ' + str(
                        dp) + ':' + str(nRules) + ',' + str(compileTime) + ',' + str(augmentTime) + ',' + str(cacheSize)
    ...
    if option == 'bgpUpdate':
        ...
        for ntot in nparts:
            ...
            print data
            msg = 'CAPEN: Completed Update Burst for ' + \
                str(ntot) + ' participants '
        ...
        for ntot in nparts:
            ...
            for npfx in npfxes:
                ...
                for dp in range(dataPoints):
                    ...
                    q = Queue()
                    p = Process(
                        target=compilationTimeExperiment,
                        args=(
                            mode,
                            ntot,
                            npfx,
